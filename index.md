...
*<center>Policy learned inside open loop environment generated by world model trained with *p*=10%.</center>*
...
*<center>Deploying policy learned inside world model (*p*=10%) to actual environment.</center>*
...
*<center>Policy learned inside open loop environment generated by another world model, this time trained with *p*=5%.</center>*
...
*<center>Deploying policy learned inside the world model (trained with *p*=5%) to actual environment.</center>*
